class Zumba : Clases
{
    ...
    public Zumba() : base("Zumba") { }

    public Zumba(string nombre) : base(nombre)
    {
        nombre = "Zumba";
    }
    ...
    public override void ChooseInstructor()
    {
        ...
        Console.WriteLine("1. Instructor Hernesto Salvatierra");
        ...
        Console.Write("Select an option: ");
        int numero = int.Parse(Console.ReadLine());
        string[] instructor = { "Instructor Hernesto Salvatierra", "Instructor Luis Chompol", "Instructor Ernesto Garcia", "Instructor Maria Lopez" };
